...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CardEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.track, track) || other.track == track)&&(identical(other.number, number) || other.number == number)&&(identical(other.validToDate, validToDate) || other.validToDate == validToDate));
}
...
@override
String toString() {
  return 'CardEntity(id: $id, track: $track, number: $number, validToDate: $validToDate)';
}
...
class _CardEntity implements CardEntity {
  const _CardEntity({this.id, this.track, this.number, this.validToDate});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CardEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.track, track) || other.track == track)&&(identical(other.number, number) || other.number == number)&&(identical(other.validToDate, validToDate) || other.validToDate == validToDate));
}
