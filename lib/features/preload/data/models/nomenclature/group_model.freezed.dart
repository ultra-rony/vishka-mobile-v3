...
class _GroupModel implements GroupModel {
  const _GroupModel({final  List<String>? imageLinks, this.parentGroup, this.order, this.isIncludedInMenu, this.isGroupModifier, this.id, this.code, this.name, this.description, this.additionalInfo, final  List<String>? tags, this.isDeleted, this.seoDescription, this.seoText, this.seoKeywords, this.seoTitle}): _imageLinks = imageLinks,_tags = tags;
