...
@override
String toString() {
  return 'CategoryModel(id: $id, name: $name, isActive: $isActive, isDefaultForNewGuests: $isDefaultForNewGuests)';
}
...
class _CategoryModel implements CategoryModel {
  const _CategoryModel({this.id, this.name, this.isActive, this.isDefaultForNewGuests});
